# Taken from: https://github.com/spiglerg/Kohonen_SOM_Tensorflow
...
class SOM:
	...
	num_expected_iterations: number of iterations to be used during training. 
		- This parameter is used to derive good parameters for the learning rate and the neighborhood radius.
	"""
	def __init__(self, input_shape, map_size_n, num_expected_iterations, session, learning_rate=0.5):
		...
		self.alpha = tf.constant( learning_rate )
